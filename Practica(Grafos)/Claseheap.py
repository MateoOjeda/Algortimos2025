...
class HeapMin:
    ...
    def search(self, value: Any):
        """
        Busca un elemento dentro del heap cuyo segundo componente
        (ej: [distancia, nodo]) coincida con `value`.
        Devuelve el índice dentro del heap o None si no está.
        """
        for i in range(len(self.elements)):
            # elementos del heap son listas como [distancia, nodo, predecesor]
